...
public class QueuePage {
    ...
    public byte @NotNull [] render(boolean loggedIn, int currentPage, long maxPage, List<QueueEntity> queueEntityList, ExtendedUserEntity userEntity) throws SQLException {
