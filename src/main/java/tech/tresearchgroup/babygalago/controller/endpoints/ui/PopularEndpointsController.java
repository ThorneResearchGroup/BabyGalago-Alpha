...
public class PopularEndpointsController extends BasicController {
    ...
    public HttpResponse popularBook(HttpRequest httpRequest) throws IOException, SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        List<BookEntity> books = bookController.readOrderByPaginated(maxResults, page, "views", false, false, httpRequest);
        ...
        byte[] data = viewPage.render(loggedIn, "Popular books:", "book", "popular", cards, settingsController.getCardWidth(userSettingsEntity), page, maxPage, userEntity, BookEntity.class, false, sortBy, false);
    ...
    public HttpResponse popularGame(HttpRequest httpRequest) throws IOException, SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        List<GameEntity> games = gameController.readOrderByPaginated(maxResults, page, "views", false, false, httpRequest);
        LinkedList<Card> cards = new LinkedList<>();
        if (games != null) {
        ...
        boolean loggedIn = verifyApiKey(httpRequest);
        String sortBy = httpRequest.getQueryParameter("sortBy");
        byte[] data = viewPage.render(loggedIn, "Popular games:", "game", "popular", cards, settingsController.getCardWidth(userSettingsEntity), page, maxPage, userEntity, GameEntity.class, false, sortBy, false);
        byte[] compressed = CompressionController.compress(data);
        return okResponseCompressed(compressed);
    }
    ...
    public HttpResponse popularMovie(HttpRequest httpRequest) throws IOException, SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        List<MovieEntity> movies = movieController.readOrderByPaginated(maxResults, page, "views", false, false, httpRequest);
        LinkedList<Card> cards = new LinkedList<>();
        if (movies != null) {
        ...
        boolean loggedIn = verifyApiKey(httpRequest);
        String sortBy = httpRequest.getQueryParameter("sortBy");
        byte[] data = viewPage.render(loggedIn, "Popular movies:", "movie", "popular", cards, settingsController.getCardWidth(userSettingsEntity), page, maxPage, userEntity, MovieEntity.class, false, sortBy, false);
        byte[] compressed = CompressionController.compress(data);
        return okResponseCompressed(compressed);
    }
    ...
    public HttpResponse popularMusic(HttpRequest httpRequest) throws IOException, SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        List<SongEntity> songs = songController.readOrderByPaginated(maxResults, page, "views", false, false, httpRequest);
        LinkedList<Card> cards = new LinkedList<>();
        if (songs != null) {
        ...
        boolean loggedIn = verifyApiKey(httpRequest);
        String sortBy = httpRequest.getQueryParameter("sortBy");
        byte[] data = viewPage.render(loggedIn, "Popular music:", "music", "popular", cards, settingsController.getCardWidth(userSettingsEntity), page, maxPage, userEntity, SongEntity.class, false, sortBy, false);
        byte[] compressed = CompressionController.compress(data);
        return okResponseCompressed(compressed);
    }
    ...
    public HttpResponse popularTvShow(HttpRequest httpRequest) throws IOException, SQLException, InvocationTargetException, NoSuchMethodException, IllegalAccessException, InstantiationException {
        ...
        List<TvShowEntity> tvShows = tvShowController.readOrderByPaginated(maxResults, page, "views", false, false, httpRequest);
        LinkedList<Card> cards = new LinkedList<>();
        if (tvShows != null) {
        ...
        String sortBy = httpRequest.getQueryParameter("sortBy");
        byte[] data = viewPage.render(loggedIn, "Popular tv shows:", "tvshow", "popular", cards, settingsController.getCardWidth(userSettingsEntity), page, maxPage, userEntity, TvShowEntity.class, false, sortBy, false);
        byte[] compressed = CompressionController.compress(data);
        return okResponseCompressed(compressed);
    }
}
